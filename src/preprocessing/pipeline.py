...
from src.preprocessing.boruta_shap_selector import HybridFeatureSelector
...
from src.preprocessing.imputer import DataFrameImputer
    ...
    def build_pipeline(self):
        ...
        if self.use_feature_selection:
            if self.selector_type == "hybrid":
                ...
                from src.preprocessing.boruta_shap_selector import BorutaSHAPSelector
                ...
                from src.preprocessing.boruta_shap_selector import ShapRFESelector
